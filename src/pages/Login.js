...
const styles = `
  ...
  *, *::before, *::after { 
  ...
  @media (min-width: 480px) { .login-card { padding: 38px 36px; } }
  @media (min-width: 768px) { .login-card { padding: 44px 48px; } }
  ...
  @media (min-width: 768px) { .login-sub { font-size:11px; letter-spacing:3px; margin-top:6px; } }
  ...
  @media (min-width: 480px) { .tab { padding:11px; font-size:13px; } }
  ...
  @media (min-width: 768px) { .field label { font-size:11px; margin-bottom:8px; } }
  ...
  @media (min-width: 480px) { .field input { padding:12px 15px 12px 44px; font-size:14px; } }
  @media (min-width: 768px) { .field input { padding:13px 15px 13px 44px; } }
  ...
  @media (min-width: 480px) { .steps { gap:8px; margin-bottom:24px; } }
  
  .step { display:flex; align-items:center; gap:5px; font-size:10px; color:var(--muted); font-weight:500; }
  @media (min-width: 480px) { .step { gap:6px; font-size:11px; } }
  ...
  @media (min-width: 480px) { .step-num { width:26px; height:26px; font-size:11px; } }
  ...
  @media (min-width: 480px) { .step-line { width:28px; } }
  ...
  @media (min-width: 480px) { .btn-main { padding:14px; font-size:17px; letter-spacing:2.8px; margin-top:5px; } }
  @media (min-width: 768px) { .btn-main { padding:15px; font-size:18px; letter-spacing:3px; margin-top:6px; } }

  .btn-main:hover:not(:disabled) {
    background: linear-gradient(135deg, #ff1a25, #ff3333);
    transform:translateY(-2px); box-shadow:0 8px 32px rgba(229,9,20,0.5);
  }
  ...
  @media (min-width: 768px) { .or-divider { margin:22px 0; font-size:11px; gap:12px; } }
  ...
  /* ══════════════════════════════════════════
     GOOGLE BUTTON — THE ACTUAL FIX
     @react-oauth/google renders an iframe inside a div.
     We must target that div AND the iframe inside it
     to force full width + centered layout.
  ══════════════════════════════════════════ */
  .google-wrap {
    width: 100%;
    display: flex;
  ...
  /* Target the auto-generated container div from GoogleLogin */
  .google-wrap > div {
    width: 100% !important;
  ...
  /* Target the iframe Google renders */
  .google-wrap iframe {
    width: 100% !important;
    margin: 0 auto !important;
  }

  /* Target any inner div Google injects */
  .google-wrap div[style] {
    width: 100% !important;
    max-width: 100% !important;
    margin: 0 !important;
  }
  ...
  @media (min-width: 480px) { .otp-field input { font-size:28px !important; letter-spacing:10px !important; padding: 14px !important; } }
  ...
  @media (min-width: 768px) { .info-box { padding:14px 16px; font-size:12px; margin-bottom:18px; line-height:1.7; } }
  ...
  .login-footer { text-align:center; margin-top:20px; color:#2a2a2a; font-size:10px; letter-spacing:1px; }
...
function Login() {
  ...
  // Shared Google button used in both tabs
  const GoogleBtn = () => (
    <>
